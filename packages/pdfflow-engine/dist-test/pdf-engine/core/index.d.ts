...
export { RESOURCE_CATEGORIES, resourceCategory, lookupResource, listResourceEntries, } from "./resources";
...
export { buildStyleAndShowReplacement, discoverTextBlockContext, effectiveVisualSize, fillColorToHex, styleChangeRequested, } from "./editor/edit-style";
export { buildShowReplacement, spliceStream } from "./editor/edit-run";
export type { StreamEdit } from "./editor/edit-run";
export { editText, editTextBytes, encodeLocator, decodeLocator, } from "./editor/edit-text";
...
export { relocateTextRuns, relocateTextRunsBytes, } from "./editor/relocate-text";
export type { MoveResult, TextMove } from "./editor/relocate-text";
export { flattenTextRuns, flattenTextRunsBytes, } from "./editor/flatten-text";
